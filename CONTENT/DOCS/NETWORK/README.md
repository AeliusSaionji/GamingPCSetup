...
- **Flow Control**
   - Disabled
   - ❓ This will destroy game streaming (steam/nv/sunshine). The end result is the network adapter is not able to sustain a video stream larger than 5mbps. If you host streaming video, leave this enabled. -Aelius
